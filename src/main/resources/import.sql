...
insert into product_table (product_id, product_name, product_unit, speed_quantity, speed_second) values (3000000000, 'prod name', 'unit', 1, 100)
insert into product_table (product_id, product_name, product_unit, speed_quantity, speed_second) values (3000000001, 'prod name', 'unit', 1, 100)
...
insert into work_table (work_id, actual_deliver_date, expect_deliver_date, order_order_id, product_product_id, plan_deliver_date, status) values (2000000000, '2017-01-01', '2017-01-01', 1000000000, 3000000000, '2017-01-01', 'New');
insert into work_table (work_id, actual_deliver_date, expect_deliver_date, order_order_id, product_product_id, plan_deliver_date, status) values (2000000001, '2017-01-01', '2017-01-01', 1000000000, 3000000001, '2017-01-01', 'New');
