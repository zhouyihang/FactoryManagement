...
insert into work_table (work_id, actual_deliver_date, expect_deliver_date, order_order_id, product_product_id, plan_deliver_date, status, quantity) values (2000000000, '2017-01-01', '2017-01-01', 1000000000, 3000000000, '2017-01-01', 'New', 10000);
insert into work_table (work_id, actual_deliver_date, expect_deliver_date, order_order_id, product_product_id, plan_deliver_date, status, quantity) values (2000000001, '2017-01-01', '2017-01-01', 1000000000, 3000000001, '2017-01-01', 'New', 10000);
